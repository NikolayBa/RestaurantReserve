...
namespace RestaurantReserve.Data.Migrations
{
    ...
    [Migration("20161204191245_fixed_a_column")]
    partial class fixed_a_column
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("RestaurantReserve.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RestaurantReserve.Models.ApplicationUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("RestaurantReserve.Models.RestaurantsUser", b =>
                {
                    b.HasOne("RestaurantReserve.Models.Restaurant", "Restaurant")
                        .WithMany("FavoriteRestaurantsUsers")
                        .HasForeignKey("RestaurantId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("RestaurantReserve.Models.ApplicationUser", "ApplicationUser")
